...
rs_test_run test_rs_errors(rs_test *test, rs_testbench *testbench, size_t msg_length,
    ...
    //printf("pad_length: %d, testbench_meslen: %d, msg_length: %d ", pad_length, testbench->message_length, msg_length);
    ...
    //printf( "mesg len: %d, encoded len: %d...", strlen(testbench->msg), strlen(testbench->encoded));
